...
//		System.out.println("Nein = 2");
	...
	System.out.println("Geben Sie an, für wie viele Tage Sie den Zins berechnet haben wollen (360 entsprechen einem Jahr): ");
	T = in.nextInt();
	
	Z = ((K * p) / 360) * T;
	
	System.out.println("Ihr Zins beträgt: "+ Z);
